...
- [Сквозные сценарии](scenarios.md) - end-to-end примеры работы системы
- [Архитектурные решения](decisions.md) - ключевые design decisions и обоснования
- [Зависимости и версии](dependencies.md) - NuGet-пакеты, версии, тестовые фреймворки
...
- **NUnit + xUnit** - тестирование (Core, Verifier, E2E: NUnit; PdfReport: xUnit)
